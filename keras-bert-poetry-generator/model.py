...
model = build_bert_model(settings.CONFIG_PATH, settings.CHECKPOINT_PATH, application='lm', keep_words=keep_words)
...
# 目标mask
y_mask = model.get_layer('Sequence-Mask').output[:, 1:]
# 预测结果，到倒数第二个（包括）时结束
